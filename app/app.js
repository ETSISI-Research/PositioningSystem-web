...
angular
  ...
  .config(function ($routeProvider, $locationProvider) {
    $routeProvider
      ...
      .when('/family/create/:projectId',                   { templateUrl: 'views/projects/families/family-create.html', controller: 'ProjectsController', title: 'Create Family' })
      .when('/family/edit/:projectId/:familyId',          { templateUrl: 'views/projects/families/family-edit.html', controller: 'ProjectsController', title: 'Edit Family' })
      .when('/family/other/view/:familyId',               { templateUrl: 'views/projects/others/families/other-family-view.html', controller: 'ProjectsController', title: 'View Family' })
      .when('/family/other/create/:projectId',            { templateUrl: 'views/projects/families/family-create.html', controller: 'ProjectsController', title: 'Create Family' })
      .when('/family/other/edit/:projectId/:familyId',    { templateUrl: 'views/projects/families/family-edit.html', controller: 'ProjectsController', title: 'Edit Family' })
      .when('/family/view/:familyId',                     { templateUrl: 'views/projects/families/family-view.html', controller: 'ProjectsController', title: 'View Family' })
      ...
      .when('/subfamily/create/:familyId',             { templateUrl: 'views/projects/subfamilies/subfamily-create.html', controller: 'ProjectsController', title: 'Create SubFamily' })
      .when('/subfamily/edit/:familyId/:subfamilyId',     { templateUrl: 'views/projects/subfamilies/subfamily-edit.html', controller: 'ProjectsController', title: 'Edit SubFamily' })
      .when('/subfamily/view/:subfamilyId',               { templateUrl: 'views/projects/subfamilies/subfamily-view.html', controller: 'ProjectsController', title: 'View Family' })
      .when('/product/create/:subfamilyId',                 { templateUrl: 'views/projects/products/product-create.html', controller: 'ProjectsController', title: 'Create Product' })
      .when('/product/edit/:subfamilyId/:productId',      { templateUrl: 'views/projects/products/product-edit.html', controller: 'ProjectsController', title: 'Edit product' })
      .when('/product/view/:productId',                   { templateUrl: 'views/projects/products/product-view.html', controller: 'ProjectsController', title: 'View Product' })
      .when('/products/finished',                         { templateUrl: 'views/projects/products/products-finished.html', controller: 'ProjectsController', title: 'View Product' })
      .when('/products/started',                          { templateUrl: 'views/projects/products/products-started.html', controller: 'ProjectsController', title: 'View Product' })
      .when('/products/notstarted',                       { templateUrl: 'views/projects/products/products-notstarted.html', controller: 'ProjectsController', title: 'View Product' })
